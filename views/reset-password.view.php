  ...
  <section class="auth-hero">
    <div class="container pt-5">
      ...
      <div class="auth-card" data-aos="fade-up" data-aos-delay="100">
        <!-- Tabs -->
         <h4 class="text-primary text-center"><span class="text-dark">Reset</span> Password</h4> 
        ...
        <div class="tab-content">
          ...
          <div class="tab-pane fade show active" id="loginTab">
            <form method="POST">
              ...
              <button type="submit" class="btn btn-primary w-100 rounded-pill py-2">Reset</button>
